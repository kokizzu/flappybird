...
# Project:  flappy.pro
# Template: app
# Command: /usr/lib/qt/bin/qmake -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile flappy.pro
#############################################################################
...
CXXFLAGS      = -pipe -std=c++11 -g -Wall -W -fPIC $(DEFINES)
...
DISTDIR = /home/kyz/Documents/flappy/.tmp/flappy1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -L/usr/lib -lSDL2 -lSDL2_image -lSDL2_mixer -lSDL2_ttf 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: flappy.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		flappy.pro
	$(QMAKE) -spec linux-g++ CONFIG+=debug CONFIG+=declarative_debug CONFIG+=qml_debug -o Makefile flappy.pro
